...
- generic [ref=e1]:
  ...
  - status [ref=e986]
  - dialog [ref=e987]:
    - generic [ref=e990]: "An error occurred while processing the AJAX request: Object reference not set to an instance of an object."
    - button "Ok" [active] [ref=e993] [cursor=pointer]:
      - generic [ref=e994]: Ok
```